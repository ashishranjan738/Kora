    ...
    return (
      <MosaicWindow<string>
        ...
        renderToolbar={(_props: MosaicWindowProps<string>, _draggable: boolean | undefined) => (
          ...
          >
            ...
            {/* Nudge button — hide notification badge in fullscreen to prevent z-index bleed */}
      ...
      >
        ...
        >
          ...
          {/* Terminal fills remaining space — hidden when fullscreen to avoid duplicate */}
  ...
  function renderFullscreenPortal() {
    ...
    return createPortal(
      ...
      >
        ...
        {/* Terminal — terminalRegistry reuses the same Terminal instance */}
        <div className="agent-panel-terminal" style={{ flex: 1, minHeight: 0, overflow: 'hidden' }}>
