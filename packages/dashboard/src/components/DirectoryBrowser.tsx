      ...
      <Stack gap={0} style={{ height: isMobile ? "calc(100vh - 80px)" : "min(520px, calc(85vh - 100px))" }}>
        ...
        <div style={{ padding: "8px 16px", borderBottom: "1px solid var(--border-color)", flexShrink: 0 }}>
          <TextInput
            ...
            rightSection={<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--text-muted)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>}
          />
        </div>
